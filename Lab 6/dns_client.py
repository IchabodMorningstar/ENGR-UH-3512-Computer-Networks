...
import sys
import socket
import bitstring  # For constructing and destructing the DNS packet.
...
def resolve_host_name(host_name_to):
    ...
    DNS_QUERY_FORMAT = [
        "hex=id", "bin=flags", "uintbe:16=qdcount", "uintbe:16=ancount", "uintbe:16=nscount", "uintbe:16=arcount"
    ]

    DNS_QUERY = {
        # Standard query. Ask for recursion.
        # One question.
        "id": "0x1a2b", "flags": "0b0000001110000000", "qdcount": 1, "ancount": 0, "nscount": 0, "arcount": 0
    }
    ...
    for i, _ in enumerate(host_name_to):
        ...
        host_name_from.append(codecs.decode(
            data[x:y].hex, "hex_codec").decode())
